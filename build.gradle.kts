...
dependencies {
    ...
    implementation("software.amazon.awssdk:netty-nio-client:2.42.8")
    ...
    implementation("io.insert-koin:koin-annotations:4.2.0-RC2")
    ksp("io.insert-koin:koin-ksp-compiler:4.2.0-RC2")
