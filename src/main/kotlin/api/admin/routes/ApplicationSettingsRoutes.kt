...
import com.baseflow.api.models.ApplicationSettingResponse
import com.baseflow.api.models.CreateApplicationSettingRequest
import com.baseflow.api.models.RotateSecretRequest
import com.baseflow.api.models.RotateSecretResponse
import com.baseflow.api.models.UpdateApplicationSettingRequest
...
fun Route.applicationSettingsRoutes() {
    route("/application-settings") {
        ...
        post {
            val body = runCatching { call.receive<CreateApplicationSettingRequest>() }.getOrNull()
            ...
            val created = transaction {
                val exists = ApplicationSettingEntity.find {
                    ApplicationSettingTable.name eq body.name
                }.firstOrNull()
            ...
            put {
                ...
                val updated = transaction {
                    ...
                    val nameConflict = existing.name != body.name &&
                        ApplicationSettingEntity.find { ApplicationSettingTable.name eq body.name }.firstOrNull() != null
...
private fun ApplicationSettingEntity.toResponse() = ApplicationSettingResponse(
