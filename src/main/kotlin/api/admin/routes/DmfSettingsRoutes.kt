...
import com.baseflow.api.models.DmfSettingsResponse
import com.baseflow.api.models.ProblemDetailsResponse
import com.baseflow.api.models.UpdateDmfSettingsRequest
import com.baseflow.api.models.badRequest
import com.baseflow.api.models.respondProblem
import com.baseflow.entities.DmfSettingsEntity
import io.ktor.http.*
    ...
    route("/dmf-settings") {
        get {
            val settings = transaction {
                DmfSettingsEntity.findById(DmfSettingsEntity.SINGLETON_ID)
        ...
        put {
            ...
            val updated = transaction {
                val settings = DmfSettingsEntity.findById(DmfSettingsEntity.SINGLETON_ID)
...
private fun DmfSettingsEntity.toResponse() = DmfSettingsResponse(
