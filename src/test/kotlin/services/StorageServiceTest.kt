...
class StorageServiceTest {
    ...
    @Test fun `Validate ms-word document`() = validateFileFormat(
        "/testdata/word_sample.docx",
        "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
    )

    @Test fun `Validate powerpoint document`() = validateFileFormat(
        "/testdata/pptx_sample.pptx",
        "application/vnd.openxmlformats-officedocument.presentationml.presentation",
    )

    @Test fun `Validate excel document`() = validateFileFormat(
        "/testdata/xlsx_sample.xlsx",
        "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
    )

    @Test fun `Validate legacy word document`() = validateFileFormat(
        "/testdata/doc_sample.doc",
        "application/vnd.ms-office",
    )

    @Test fun `Validate legacy powerpoint document`() = validateFileFormat("/testdata/ppt_sample.ppt", "application/vnd.ms-office")

    @Test fun `Validate legacy excel document`() = validateFileFormat(
        "/testdata/xls_sample.xls",
        "application/vnd.ms-office",
    )

    // Autocad
    @Test fun `Validate dwg file format detection`() = validateFileFormat(
        "/testdata/dwg_sample.dwg",
        "application/acad",
    )
