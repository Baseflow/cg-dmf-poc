...
class BestandsDelenRoutesTest : TestBase("bestandsdelen_routes") {
    ...
    companion object {
        ...
        /**
         * Tiny trigger/chunk config so an EIO with a small [com.baseflow.entities.EIOVersions.bestandsomvang] triggers chunking
    ...
    /**
     * Creates an EIO with a large enough [com.baseflow.entities.EIOVersions.bestandsomvang] to trigger chunked upload,
